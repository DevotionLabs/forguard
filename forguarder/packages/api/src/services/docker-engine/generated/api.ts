...
export const ConfigApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		configDelete: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/configs/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		configUpdate: async (
			...
			const localVarPath = `/configs/{id}/update`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const ConfigApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async configCreate(
			...
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.configCreate(body, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ConfigApi.configCreate"]?.[localVarOperationServerIndex]?.url;
		...
		async configDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ConfigApi.configDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async configInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ConfigApi.configInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async configList(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Config>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.configList(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ConfigApi.configList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async configUpdate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ConfigApi.configUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const ConfigApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		configCreate(body?: ConfigCreateRequest, options?: RawAxiosRequestConfig): AxiosPromise<IdResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		configDelete(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		configInspect(id: string, options?: RawAxiosRequestConfig): AxiosPromise<Config> {
		 ...
		 * @throws {RequiredError}
		 */
		configList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Config>> {
		 ...
		 * @throws {RequiredError}
		 */
		configUpdate(id: string, version: number, body?: ConfigSpec, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class ConfigApi extends BaseAPI {
	...
	public configUpdate(id: string, version: number, body?: ConfigSpec, options?: RawAxiosRequestConfig) {
		return ConfigApiFp(this.configuration)
			.configUpdate(id, version, body, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const ContainerApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		containerArchive: async (id: string, path: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/archive`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerAttach: async (
			...
			const localVarPath = `/containers/{id}/attach`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		 ...
		 * @throws {RequiredError}
		 */
		containerAttachWebsocket: async (
			id: string,
			detachKeys?: string,
			logs?: boolean,
			stream?: boolean,
			...
			const localVarPath = `/containers/{id}/attach/ws`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerChanges: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/changes`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerDelete: async (
			...
			const localVarPath = `/containers/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerExport: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/export`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerInspect: async (id: string, size?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/json`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerKill: async (id: string, signal?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/kill`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerLogs: async (
			...
			const localVarPath = `/containers/{id}/logs`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerPause: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/pause`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerRename: async (id: string, name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/rename`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerResize: async (
			...
			const localVarPath = `/containers/{id}/resize`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerRestart: async (
			...
			const localVarPath = `/containers/{id}/restart`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerStart: async (
			...
			const localVarPath = `/containers/{id}/start`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerStats: async (
			...
			const localVarPath = `/containers/{id}/stats`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerStop: async (
			...
			const localVarPath = `/containers/{id}/stop`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerTop: async (id: string, psArgs?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/top`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerUnpause: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/containers/{id}/unpause`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerUpdate: async (
			...
			const localVarPath = `/containers/{id}/update`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		containerWait: async (
			...
			const localVarPath = `/containers/{id}/wait`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const ContainerApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async containerArchive(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerArchive"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerArchiveInfo(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerArchiveInfo"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerAttach(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerAttach(
				id,
				detachKeys,
				logs,
				stream,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerAttach"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerAttachWebsocket(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerAttachWebsocket(
				id,
				detachKeys,
				logs,
				stream,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerAttachWebsocket"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerChanges(
			id: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FilesystemChange>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerChanges(id, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerChanges"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerCreate(
			...
			platform?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerCreateResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerCreate(body, name, platform, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerExport(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerExport"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerInspect(
			...
			size?: boolean,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerInspectResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerInspect(id, size, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerKill(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerKill"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerList(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContainerSummary>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerList(all, limit, size, filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerLogs(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerLogs(
				id,
				follow,
				stdout,
				stderr,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerLogs"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerPause(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerPause"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerPrune(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerPruneResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerPrune(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerPrune"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerRename(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerRename"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerResize(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerResize"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerRestart(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerRestart"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerStart(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerStart"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerStats(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerStats"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerStop(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerStop"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerTop(
			...
			psArgs?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerTopResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerTop(id, psArgs, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerTop"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerUnpause(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerUnpause"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerUpdate(
			...
			update: ContainerUpdateRequest,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerUpdateResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerUpdate(id, update, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async containerWait(
			...
			condition?: ContainerWaitConditionEnum,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerWaitResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.containerWait(id, condition, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.containerWait"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async putContainerArchive(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.putContainerArchive(
				id,
				path,
				inputStream,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ContainerApi.putContainerArchive"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const ContainerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		containerArchive(id: string, path: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerArchiveInfo(id: string, path: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		containerAttach(
			...
			return localVarFp
				.containerAttach(id, detachKeys, logs, stream, stdin, stdout, stderr, options)
		...
		containerAttachWebsocket(
			...
			return localVarFp
				.containerAttachWebsocket(id, detachKeys, logs, stream, stdin, stdout, stderr, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Returns which files in a container\'s filesystem have been added, deleted, or modified. The `Kind` of modification can be one of:  - `0`: Modified (\"C\") - `1`: Added (\"A\") - `2`: Deleted (\"D\")
		 ...
		 * @throws {RequiredError}
		 */
		containerChanges(id: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<FilesystemChange>> {
		...
		containerCreate(
			...
			platform?: string,
			options?: RawAxiosRequestConfig
		): AxiosPromise<ContainerCreateResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		containerExport(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		containerInspect(
			...
			size?: boolean,
			options?: RawAxiosRequestConfig
		): AxiosPromise<ContainerInspectResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		containerKill(id: string, signal?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		containerList(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): AxiosPromise<Array<ContainerSummary>> {
		...
		containerLogs(
			...
			return localVarFp
				.containerLogs(id, follow, stdout, stderr, since, until, timestamps, tail, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Use the freezer cgroup to suspend all processes in a container.  Traditionally, when suspending a process the `SIGSTOP` signal is used, which is observable by the process being suspended. With the freezer cgroup the process is unaware, and unable to capture, that it is being suspended, and subsequently resumed.
		 ...
		 * @throws {RequiredError}
		 */
		containerPause(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerPrune(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<ContainerPruneResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		containerRename(id: string, name: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerResize(id: string, h?: number, w?: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerRestart(id: string, signal?: string, t?: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerStart(id: string, detachKeys?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerStop(id: string, signal?: string, t?: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		containerTop(id: string, psArgs?: string, options?: RawAxiosRequestConfig): AxiosPromise<ContainerTopResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		containerUnpause(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		containerUpdate(
			...
			update: ContainerUpdateRequest,
			options?: RawAxiosRequestConfig
		): AxiosPromise<ContainerUpdateResponse> {
		...
		containerWait(
			...
			condition?: ContainerWaitConditionEnum,
			options?: RawAxiosRequestConfig
		): AxiosPromise<ContainerWaitResponse> {
		...
		putContainerArchive(
			...
			return localVarFp
				.putContainerArchive(id, path, inputStream, noOverwriteDirNonDir, copyUIDGID, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class ContainerApi extends BaseAPI {
	...
	public containerArchive(id: string, path: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerArchive(id, path, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerArchiveInfo(id: string, path: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerArchiveInfo(id, path, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerCreate(
		...
		return ContainerApiFp(this.configuration)
			.containerCreate(body, name, platform, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerDelete(id: string, v?: boolean, force?: boolean, link?: boolean, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerDelete(id, v, force, link, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerInspect(id: string, size?: boolean, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerInspect(id, size, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerKill(id: string, signal?: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerKill(id, signal, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerList(
		...
		return ContainerApiFp(this.configuration)
			.containerList(all, limit, size, filters, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerPrune(filters?: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerPrune(filters, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerRename(id: string, name: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerRename(id, name, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerResize(id: string, h?: number, w?: number, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerResize(id, h, w, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerRestart(id: string, signal?: string, t?: number, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerRestart(id, signal, t, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerStart(id: string, detachKeys?: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerStart(id, detachKeys, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerStats(id: string, stream?: boolean, oneShot?: boolean, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerStats(id, stream, oneShot, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerStop(id: string, signal?: string, t?: number, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerStop(id, signal, t, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerTop(id: string, psArgs?: string, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerTop(id, psArgs, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerUpdate(id: string, update: ContainerUpdateRequest, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerUpdate(id, update, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public containerWait(id: string, condition?: ContainerWaitConditionEnum, options?: RawAxiosRequestConfig) {
		return ContainerApiFp(this.configuration)
			.containerWait(id, condition, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const DistributionApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		distributionInspect: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/distribution/{name}/json`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const DistributionApiFp = function (configuration?: Configuration) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async distributionInspect(
			name: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DistributionInspect>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.distributionInspect(name, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["DistributionApi.distributionInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const DistributionApiFactory = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		distributionInspect(name: string, options?: RawAxiosRequestConfig): AxiosPromise<DistributionInspect> {
...
export class DistributionApi extends BaseAPI {
	...
	public distributionInspect(name: string, options?: RawAxiosRequestConfig) {
		return DistributionApiFp(this.configuration)
			.distributionInspect(name, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const ExecApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		containerExec: async (
			...
			const localVarPath = `/containers/{id}/exec`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		execInspect: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/exec/{id}/json`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		execResize: async (
			...
			const localVarPath = `/exec/{id}/resize`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		execStart: async (
			...
			const localVarPath = `/exec/{id}/start`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const ExecApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async containerExec(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ExecApi.containerExec"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async execInspect(
			id: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExecInspectResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.execInspect(id, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ExecApi.execInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async execResize(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ExecApi.execResize"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async execStart(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ExecApi.execStart"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const ExecApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		containerExec(id: string, execConfig: ExecConfig, options?: RawAxiosRequestConfig): AxiosPromise<IdResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		execInspect(id: string, options?: RawAxiosRequestConfig): AxiosPromise<ExecInspectResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		execResize(id: string, h?: number, w?: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		execStart(id: string, execStartConfig?: ExecStartConfig, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class ExecApi extends BaseAPI {
	...
	public containerExec(id: string, execConfig: ExecConfig, options?: RawAxiosRequestConfig) {
		return ExecApiFp(this.configuration)
			.containerExec(id, execConfig, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public execStart(id: string, execStartConfig?: ExecStartConfig, options?: RawAxiosRequestConfig) {
		return ExecApiFp(this.configuration)
			.execStart(id, execStartConfig, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const ImageApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		imageDelete: async (
			...
			const localVarPath = `/images/{name}`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		imageGet: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/images/{name}/get`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		imageHistory: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/images/{name}/history`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		imageInspect: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/images/{name}/json`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		imagePush: async (
			...
			const localVarPath = `/images/{name}/push`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		imageTag: async (
			...
			const localVarPath = `/images/{name}/tag`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const ImageApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async buildPrune(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BuildPruneResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.buildPrune(keepStorage, all, filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.buildPrune"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageBuild(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageBuild(
				dockerfile,
				t,
				extrahosts,
				remote,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageBuild"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageCommit(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageCommit(
				container,
				repo,
				tag,
				comment,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageCommit"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageCreate(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageCreate(
				fromImage,
				fromSrc,
				repo,
				tag,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageDelete(
			...
			noprune?: boolean,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ImageDeleteResponseItem>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageDelete(name, force, noprune, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageGet(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageGet"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageGetAll(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageGetAll"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageHistory(
			name: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<HistoryResponseItem>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageHistory(name, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageHistory"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageInspect(
			name: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImageInspect>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageInspect(name, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageList(
			...
			digests?: boolean,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ImageSummary>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageList(all, filters, sharedSize, digests, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageLoad(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageLoad"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imagePrune(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImagePruneResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.imagePrune(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imagePrune"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imagePush(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imagePush"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageSearch(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ImageSearchResponseItem>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.imageSearch(term, limit, filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageSearch"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async imageTag(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ImageApi.imageTag"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const ImageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		...
		buildPrune(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): AxiosPromise<BuildPruneResponse> {
		...
		imageCommit(
			...
			containerConfig?: ContainerConfig,
			options?: RawAxiosRequestConfig
		): AxiosPromise<IdResponse> {
			return localVarFp
				.imageCommit(container, repo, tag, comment, author, pause, changes, containerConfig, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Create an image by either pulling it from a registry or importing it.
		...
		imageCreate(
			...
			return localVarFp
				.imageCreate(fromImage, fromSrc, repo, tag, message, xRegistryAuth, changes, platform, inputImage, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove an image, along with any untagged parent images that were referenced by that image.  Images can\'t be removed if they have descendant images, are being used by a running container or are being used by a build.
		...
		imageDelete(
			...
			noprune?: boolean,
			options?: RawAxiosRequestConfig
		): AxiosPromise<Array<ImageDeleteResponseItem>> {
		 ...
		 * @throws {RequiredError}
		 */
		imageGet(name: string, options?: RawAxiosRequestConfig): AxiosPromise<File> {
		 ...
		 * @throws {RequiredError}
		 */
		imageGetAll(names?: Array<string>, options?: RawAxiosRequestConfig): AxiosPromise<File> {
		 ...
		 * @throws {RequiredError}
		 */
		imageHistory(name: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<HistoryResponseItem>> {
		 ...
		 * @throws {RequiredError}
		 */
		imageInspect(name: string, options?: RawAxiosRequestConfig): AxiosPromise<ImageInspect> {
		...
		imageList(
			...
			digests?: boolean,
			options?: RawAxiosRequestConfig
		): AxiosPromise<Array<ImageSummary>> {
			return localVarFp
				.imageList(all, filters, sharedSize, digests, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Load a set of images and tags into a repository.  For details on the format, see the [export image endpoint](#operation/ImageGet).
		 ...
		 * @throws {RequiredError}
		 */
		imageLoad(quiet?: boolean, imagesTarball?: File, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		imagePrune(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<ImagePruneResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		imagePush(name: string, xRegistryAuth: string, tag?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		imageSearch(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): AxiosPromise<Array<ImageSearchResponseItem>> {
		 ...
		 * @throws {RequiredError}
		 */
		imageTag(name: string, repo?: string, tag?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class ImageApi extends BaseAPI {
	...
	public buildPrune(keepStorage?: number, all?: boolean, filters?: string, options?: RawAxiosRequestConfig) {
		return ImageApiFp(this.configuration)
			.buildPrune(keepStorage, all, filters, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public imageDelete(name: string, force?: boolean, noprune?: boolean, options?: RawAxiosRequestConfig) {
		return ImageApiFp(this.configuration)
			.imageDelete(name, force, noprune, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public imageLoad(quiet?: boolean, imagesTarball?: File, options?: RawAxiosRequestConfig) {
		return ImageApiFp(this.configuration)
			.imageLoad(quiet, imagesTarball, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public imagePush(name: string, xRegistryAuth: string, tag?: string, options?: RawAxiosRequestConfig) {
		return ImageApiFp(this.configuration)
			.imagePush(name, xRegistryAuth, tag, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public imageSearch(term: string, limit?: number, filters?: string, options?: RawAxiosRequestConfig) {
		return ImageApiFp(this.configuration)
			.imageSearch(term, limit, filters, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public imageTag(name: string, repo?: string, tag?: string, options?: RawAxiosRequestConfig) {
		return ImageApiFp(this.configuration)
			.imageTag(name, repo, tag, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const NetworkApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		networkConnect: async (
			...
			const localVarPath = `/networks/{id}/connect`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		networkDelete: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/networks/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		networkDisconnect: async (
			...
			const localVarPath = `/networks/{id}/disconnect`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const NetworkApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async networkConnect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkConnect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async networkCreate(
			networkConfig: NetworkCreateRequest,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NetworkCreateResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.networkCreate(networkConfig, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async networkDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async networkDisconnect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkDisconnect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async networkInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async networkList(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async networkPrune(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NetworkPruneResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.networkPrune(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NetworkApi.networkPrune"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const NetworkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		networkConnect(id: string, container: NetworkConnectRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		networkCreate(
			networkConfig: NetworkCreateRequest,
			options?: RawAxiosRequestConfig
		): AxiosPromise<NetworkCreateResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		networkDelete(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		networkList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Network>> {
		 ...
		 * @throws {RequiredError}
		 */
		networkPrune(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<NetworkPruneResponse> {
...
export class NetworkApi extends BaseAPI {
	...
	public networkConnect(id: string, container: NetworkConnectRequest, options?: RawAxiosRequestConfig) {
		return NetworkApiFp(this.configuration)
			.networkConnect(id, container, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public networkCreate(networkConfig: NetworkCreateRequest, options?: RawAxiosRequestConfig) {
		return NetworkApiFp(this.configuration)
			.networkCreate(networkConfig, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public networkDisconnect(id: string, container: NetworkDisconnectRequest, options?: RawAxiosRequestConfig) {
		return NetworkApiFp(this.configuration)
			.networkDisconnect(id, container, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public networkInspect(id: string, verbose?: boolean, scope?: string, options?: RawAxiosRequestConfig) {
		return NetworkApiFp(this.configuration)
			.networkInspect(id, verbose, scope, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const NodeApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		nodeDelete: async (id: string, force?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/nodes/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		nodeUpdate: async (
			...
			const localVarPath = `/nodes/{id}/update`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const NodeApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async nodeDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NodeApi.nodeDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async nodeInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NodeApi.nodeInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async nodeList(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Node>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.nodeList(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NodeApi.nodeList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async nodeUpdate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["NodeApi.nodeUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const NodeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		nodeDelete(id: string, force?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		nodeInspect(id: string, options?: RawAxiosRequestConfig): AxiosPromise<Node> {
		 ...
		 * @throws {RequiredError}
		 */
		nodeList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Node>> {
		 ...
		 * @throws {RequiredError}
		 */
		nodeUpdate(id: string, version: number, body?: NodeSpec, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class NodeApi extends BaseAPI {
	...
	public nodeUpdate(id: string, version: number, body?: NodeSpec, options?: RawAxiosRequestConfig) {
		return NodeApiFp(this.configuration)
			.nodeUpdate(id, version, body, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const PluginApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		pluginDelete: async (name: string, force?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/plugins/{name}`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		pluginDisable: async (name: string, force?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/plugins/{name}/disable`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		pluginEnable: async (name: string, timeout?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/plugins/{name}/enable`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		pluginInspect: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/plugins/{name}/json`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		pluginPush: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/plugins/{name}/push`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		pluginSet: async (
			...
			const localVarPath = `/plugins/{name}/set`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		pluginUpgrade: async (
			...
			const localVarPath = `/plugins/{name}/upgrade`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const PluginApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async getPluginPrivileges(
			remote: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PluginPrivilege>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getPluginPrivileges(remote, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.getPluginPrivileges"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginCreate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginDisable(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginDisable"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginEnable(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginEnable"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginList(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginPull(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginPull"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginPush(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginPush"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginSet(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginSet"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async pluginUpgrade(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.pluginUpgrade(
				name,
				remote,
				xRegistryAuth,
				body,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["PluginApi.pluginUpgrade"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const PluginApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		getPluginPrivileges(remote: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<PluginPrivilege>> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginCreate(name: string, tarContext?: File, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginDelete(name: string, force?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<Plugin> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginDisable(name: string, force?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginEnable(name: string, timeout?: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginInspect(name: string, options?: RawAxiosRequestConfig): AxiosPromise<Plugin> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Plugin>> {
		...
		pluginPull(
			...
			return localVarFp
				.pluginPull(remote, name, xRegistryAuth, body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Push a plugin to the registry.
		 ...
		 * @throws {RequiredError}
		 */
		pluginPush(name: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		pluginSet(name: string, body?: Array<string>, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		pluginUpgrade(
			...
			return localVarFp
				.pluginUpgrade(name, remote, xRegistryAuth, body, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class PluginApi extends BaseAPI {
	...
	public getPluginPrivileges(remote: string, options?: RawAxiosRequestConfig) {
		return PluginApiFp(this.configuration)
			.getPluginPrivileges(remote, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public pluginCreate(name: string, tarContext?: File, options?: RawAxiosRequestConfig) {
		return PluginApiFp(this.configuration)
			.pluginCreate(name, tarContext, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public pluginDelete(name: string, force?: boolean, options?: RawAxiosRequestConfig) {
		return PluginApiFp(this.configuration)
			.pluginDelete(name, force, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public pluginDisable(name: string, force?: boolean, options?: RawAxiosRequestConfig) {
		return PluginApiFp(this.configuration)
			.pluginDisable(name, force, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public pluginEnable(name: string, timeout?: number, options?: RawAxiosRequestConfig) {
		return PluginApiFp(this.configuration)
			.pluginEnable(name, timeout, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const SecretApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		secretDelete: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/secrets/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		secretUpdate: async (
			...
			const localVarPath = `/secrets/{id}/update`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const SecretApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async secretCreate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SecretApi.secretCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async secretDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SecretApi.secretDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async secretInspect(
			id: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Secret>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.secretInspect(id, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SecretApi.secretInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async secretList(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Secret>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.secretList(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SecretApi.secretList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async secretUpdate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SecretApi.secretUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const SecretApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		secretCreate(body?: SecretCreateRequest, options?: RawAxiosRequestConfig): AxiosPromise<IdResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		secretDelete(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		secretInspect(id: string, options?: RawAxiosRequestConfig): AxiosPromise<Secret> {
		 ...
		 * @throws {RequiredError}
		 */
		secretList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Secret>> {
		 ...
		 * @throws {RequiredError}
		 */
		secretUpdate(id: string, version: number, body?: SecretSpec, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class SecretApi extends BaseAPI {
	...
	public secretUpdate(id: string, version: number, body?: SecretSpec, options?: RawAxiosRequestConfig) {
		return SecretApiFp(this.configuration)
			.secretUpdate(id, version, body, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const ServiceApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		serviceLogs: async (
			...
			const localVarPath = `/services/{id}/logs`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
		...
		serviceUpdate: async (
			...
			const localVarPath = `/services/{id}/update`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const ServiceApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async serviceCreate(
			...
			xRegistryAuth?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceCreateResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.serviceCreate(body, xRegistryAuth, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ServiceApi.serviceCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async serviceDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ServiceApi.serviceDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async serviceInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ServiceApi.serviceInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async serviceList(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ServiceApi.serviceList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async serviceLogs(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.serviceLogs(
				id,
				details,
				follow,
				stdout,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ServiceApi.serviceLogs"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async serviceUpdate(
			...
			xRegistryAuth?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceUpdateResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.serviceUpdate(
				id,
				version,
				body,
				registryAuthFrom,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["ServiceApi.serviceUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const ServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		...
		serviceCreate(
			...
			xRegistryAuth?: string,
			options?: RawAxiosRequestConfig
		): AxiosPromise<ServiceCreateResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		serviceDelete(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		serviceInspect(id: string, insertDefaults?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<Service> {
		 ...
		 * @throws {RequiredError}
		 */
		serviceList(filters?: string, status?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<Array<Service>> {
		...
		serviceLogs(
			...
			return localVarFp
				.serviceLogs(id, details, follow, stdout, stderr, since, timestamps, tail, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		serviceUpdate(
			...
			return localVarFp
				.serviceUpdate(id, version, body, registryAuthFrom, rollback, xRegistryAuth, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class ServiceApi extends BaseAPI {
	...
	public serviceCreate(body: ServiceCreateRequest, xRegistryAuth?: string, options?: RawAxiosRequestConfig) {
		return ServiceApiFp(this.configuration)
			.serviceCreate(body, xRegistryAuth, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public serviceInspect(id: string, insertDefaults?: boolean, options?: RawAxiosRequestConfig) {
		return ServiceApiFp(this.configuration)
			.serviceInspect(id, insertDefaults, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public serviceList(filters?: string, status?: boolean, options?: RawAxiosRequestConfig) {
		return ServiceApiFp(this.configuration)
			.serviceList(filters, status, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export type ServiceUpdateRegistryAuthFromEnum =
	(typeof ServiceUpdateRegistryAuthFromEnum)[keyof typeof ServiceUpdateRegistryAuthFromEnum];
...
export const SessionApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async session(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SessionApi.session"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const SwarmApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async swarmInit(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmInit"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async swarmInspect(
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Swarm>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.swarmInspect(options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async swarmJoin(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmJoin"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async swarmLeave(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmLeave"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async swarmUnlock(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmUnlock"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async swarmUnlockkey(
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UnlockKeyResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.swarmUnlockkey(options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmUnlockkey"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async swarmUpdate(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.swarmUpdate(
				version,
				body,
				rotateWorkerToken,
				rotateManagerToken,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SwarmApi.swarmUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const SwarmApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		swarmInit(body: SwarmInitRequest, options?: RawAxiosRequestConfig): AxiosPromise<string> {
		 ...
		 * @throws {RequiredError}
		 */
		swarmJoin(body: SwarmJoinRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		swarmLeave(force?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		swarmUnlock(body: SwarmUnlockRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		...
		swarmUpdate(
			...
			return localVarFp
				.swarmUpdate(version, body, rotateWorkerToken, rotateManagerToken, rotateManagerUnlockKey, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export const SystemApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async systemAuth(
			...
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemAuthResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.systemAuth(authConfig, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemAuth"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async systemDataUsage(
			type?: Array<SystemDataUsageTypeEnum>,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemDataUsageResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.systemDataUsage(type, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemDataUsage"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async systemEvents(
			...
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventMessage>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.systemEvents(since, until, filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemEvents"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async systemInfo(
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemInfo>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.systemInfo(options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemInfo"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async systemPing(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemPing"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async systemPingHead(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemPingHead"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async systemVersion(
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemVersion>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.systemVersion(options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["SystemApi.systemVersion"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const SystemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		systemAuth(authConfig?: AuthConfig, options?: RawAxiosRequestConfig): AxiosPromise<SystemAuthResponse> {
		...
		systemDataUsage(
			type?: Array<SystemDataUsageTypeEnum>,
			options?: RawAxiosRequestConfig
		): AxiosPromise<SystemDataUsageResponse> {
...
export class SystemApi extends BaseAPI {
	...
	public systemEvents(since?: string, until?: string, filters?: string, options?: RawAxiosRequestConfig) {
		return SystemApiFp(this.configuration)
			.systemEvents(since, until, filters, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const TaskApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		taskLogs: async (
			...
			const localVarPath = `/tasks/{id}/logs`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const TaskApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async taskInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["TaskApi.taskInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async taskList(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["TaskApi.taskList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async taskLogs(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.taskLogs(
				id,
				details,
				follow,
				stdout,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["TaskApi.taskLogs"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const TaskApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		taskInspect(id: string, options?: RawAxiosRequestConfig): AxiosPromise<Task> {
		 ...
		 * @throws {RequiredError}
		 */
		taskList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Task>> {
		...
		taskLogs(
			...
			return localVarFp
				.taskLogs(id, details, follow, stdout, stderr, since, timestamps, tail, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export const VolumeApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		volumeDelete: async (name: string, force?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/volumes/{name}`.replace(`{${"name"}}`, encodeURIComponent(String(name)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const VolumeApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async volumeCreate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["VolumeApi.volumeCreate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async volumeDelete(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["VolumeApi.volumeDelete"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async volumeInspect(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["VolumeApi.volumeInspect"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async volumeList(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VolumeListResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.volumeList(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["VolumeApi.volumeList"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async volumePrune(
			filters?: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VolumePruneResponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.volumePrune(filters, options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["VolumeApi.volumePrune"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async volumeUpdate(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["VolumeApi.volumeUpdate"]?.[localVarOperationServerIndex]?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const VolumeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		volumeCreate(volumeConfig: VolumeCreateOptions, options?: RawAxiosRequestConfig): AxiosPromise<Volume> {
		 ...
		 * @throws {RequiredError}
		 */
		volumeDelete(name: string, force?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<void> {
		 ...
		 * @throws {RequiredError}
		 */
		volumeInspect(name: string, options?: RawAxiosRequestConfig): AxiosPromise<Volume> {
		 ...
		 * @throws {RequiredError}
		 */
		volumeList(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<VolumeListResponse> {
		 ...
		 * @throws {RequiredError}
		 */
		volumePrune(filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<VolumePruneResponse> {
...
export class VolumeApi extends BaseAPI {
	...
	public volumeCreate(volumeConfig: VolumeCreateOptions, options?: RawAxiosRequestConfig) {
		return VolumeApiFp(this.configuration)
			.volumeCreate(volumeConfig, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public volumeDelete(name: string, force?: boolean, options?: RawAxiosRequestConfig) {
		return VolumeApiFp(this.configuration)
			.volumeDelete(name, force, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public volumeUpdate(name: string, version: number, body?: VolumeUpdateRequest, options?: RawAxiosRequestConfig) {
		return VolumeApiFp(this.configuration)
			.volumeUpdate(name, version, body, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
